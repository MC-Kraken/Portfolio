            ...
            <Container>
                <Row className="about justify-content-center">
                    ...
                    <Col xs={{ span: 12, order: 2 }} sm={{ span: 12, order: 2 }} md={10} lg={9} className="about-text">
                        Thanks for checking out my site. I&apos;m Blake, a Fullstack Software Engineer based in Seattle, WA,
                        with five years of experience in the tech industry.
                        <br />
                        <br />
                        Outside of building software, I have passions for gaming, urbanism, weight lifting, and exploring the breathtaking
                        outdoors of Seattle. If you want to chat about tech, trains, hiking, biking, gaming, or PRs (Pull Requests or Personal Records),
